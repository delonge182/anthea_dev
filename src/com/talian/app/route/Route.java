...
//		Double last_etd = 0.0 ;
	...
	public class VisitedPort implements IFuelPoint, IValidationPoint {
		...
		public void setPaxon(int paxon) {
			this.paxon = paxon;
		}

		public int getPaxoff() {
			return paxoff;
		}

		public void setPaxoff(int paxoff) {
			this.paxoff = paxoff;
		}

		public Double getWeighton() {
			return weighton;
		}

		public void setWeighton(Double weighton) {
			this.weighton = weighton;
		}

		public Double getWeightoff() {
			return weightoff;
		}

		public void setWeightoff(Double weightoff) {
		...
		public Double getFueluploadneed() {
			return fueluploadneed;
		}

		public void setFueluploadneed(Double fueluploadneed) {
			this.fueluploadneed = fueluploadneed;
		}
		...
		public void setPobvalid(boolean pobvalid) {
			this.pobvalid = pobvalid;
		}
		...
		public void setWobvalid(boolean wobvalid) {
			this.wobvalid = wobvalid;
		}
		...
		public void setFuelvalid(boolean fuelvalid) {
			this.fuelvalid = fuelvalid;
		}
		...
		public void setSeqvalid(boolean seqvalid) {
